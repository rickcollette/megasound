...
import "github.com/rickcollette/megasound"
...
func Doppler(quality int, samplesPerMeter float64, s megasound.Streamer, distance func(delta int) float64) megasound.Streamer {
	return &doppler{
		r:               megasound.ResampleRatio(quality, 1, s),
		distance:        distance,
