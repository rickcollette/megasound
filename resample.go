...
// through a megasound.Mixer, or through a speaker. Speaker has a constant sample rate. Thus, playing
...
//   speaker.Play(megasound.Resample(3, format.SampleRate, sr, s))
//
