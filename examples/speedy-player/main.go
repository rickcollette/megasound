...
type audioPanel struct {
	sampleRate megasound.SampleRate
	streamer   megasound.StreamSeeker
	ctrl       *megasound.Ctrl
	resampler  *megasound.Resampler
	volume     *effects.Volume
}

func newAudioPanel(sampleRate megasound.SampleRate, streamer megasound.StreamSeeker) *audioPanel {
	ctrl := &megasound.Ctrl{Streamer: megasound.Loop(-1, streamer)}
	resampler := megasound.ResampleRatio(4, 1, ctrl)
